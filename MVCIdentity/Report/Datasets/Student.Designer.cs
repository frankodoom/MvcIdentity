...
namespace MVCIdentity.Report.Datasets {
    ...
    public partial class Student : global::System.Data.DataSet {
        ...
        public partial class StudentsDataTable : global::System.Data.TypedTableBase<StudentsRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "15.0.0.0")]
            public StudentsRow AddStudentsRow(string StudentId, string FirstName, string MiddleName, string LastName, string Gender) {
            ...
            private void InitClass() {
                ...
                this.columnStudentId.MaxLength = 128;
...
namespace MVCIdentity.Report.Datasets.StudentTableAdapters {
    ...
    public partial class StudentsTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Students] ([StudentId], [FirstName], [MiddleName], [LastName]," +
                " [Gender]) VALUES (@StudentId, @FirstName, @MiddleName, @LastName, @Gender)";
            ...
            this._adapter.UpdateCommand.CommandText = "UPDATE [dbo].[Students] SET [StudentId] = @StudentId, [FirstName] = @FirstName, [" +
                "MiddleName] = @MiddleName, [LastName] = @LastName, [Gender] = @Gender WHERE (([S" +
                "tudentId] = @Original_StudentId))";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT StudentId, FirstName, MiddleName, LastName, Gender FROM dbo.Students";
        ...
        public virtual int Fill(Student.StudentsDataTable dataTable) {
        ...
        public virtual Student.StudentsDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            Student.StudentsDataTable dataTable = new Student.StudentsDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "15.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(Student.StudentsDataTable dataTable) {
        ...
        public virtual int Insert(string StudentId, string FirstName, string MiddleName, string LastName, string Gender) {
            if ((StudentId == null)) {
        ...
        public virtual int Update(string StudentId, string FirstName, string MiddleName, string LastName, string Gender, string Original_StudentId) {
            if ((StudentId == null)) {
                throw new global::System.ArgumentNullException("StudentId");
            }
            else {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string FirstName, string MiddleName, string LastName, string Gender, string Original_StudentId) {
            return this.Update(Original_StudentId, FirstName, MiddleName, LastName, Gender, Original_StudentId);
        }
    }
